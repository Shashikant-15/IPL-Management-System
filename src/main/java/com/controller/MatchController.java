...
//return match scheduling page
   ...
   matchService.AddMatch(model);
     ...
     * @return the string
     */
//Save a scheduled match and return view match page
    ...
    public String updateMatch(@Valid @ModelAttribute("match") MatchModel match, final BindingResult result, RedirectAttributes redirectAttributes) {
    ...
    public String updateScore(@Valid @ModelAttribute("match") MatchModel match, final BindingResult result) {
        ...
        if (result.hasErrors()) {
            ...
            match = resultService.getResult(match);
